...
const config = {
    apiKey: "AIzaSyBnUugwa1YPmFpRyy7fZiNeHnEiTekdG50",
    authDomain: "chattest-b9935.firebaseapp.com",
    databaseURL: "https://chattest-b9935.firebaseio.com",
    projectId: "chattest-b9935",
    storageBucket: "chattest-b9935.appspot.com",
    messagingSenderId: "493504293379",
        ...
        .then(function (pass) {
          ...
          userf.updateProfile({ displayName: user.name })
            .then(function () {
              ...
              localStorage.setItem('user',JSON.stringify({uid:pass.user.uid,email:pass.user.email,name:user.name}))
                .then(function () {
