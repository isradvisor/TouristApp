...
export default ({ route, navigation }) => {
      ...
      .then(
        (result) => {
          ...
          switch (result) {
            ...
            case 1:
              let ifExist = true;
                AsyncStorage.setItem('firstTimeInIsrael',JSON.stringify(ifExist))
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center' }}>
      <FadeInView style={{flex:0.2, marginTop: 150 }}>
      ...
      <FadeInView style={{flex:0.8,justifyContent: 'center' }}>
        <Image
          source={require('../pictures/firstTimeInIsrael.jpg')}
          style={{flex:0.8, width: 350, height: '45%', alignSelf: 'center', paddingLeft: '5%', paddingRight: '5%', borderRadius: 150, opacity: 30 }}
