    ...
    return (
        <View style={styles.headerContainer}>
            ...
            <View style={styles.socialMediaRow}>
                ...
                <SocialIcon type='facebook' onPress={() => { Linking.openURL('https://www.facebook.com/nil.givol?ref=bookmarks') }} />
                <SocialIcon type='instagram' onPress={() => { Linking.openURL('https://www.instagram.com/nilgivol/') }} />
            </View>
        </View>
    );
}
