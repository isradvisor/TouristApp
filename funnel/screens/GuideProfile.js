                ...
                (result) => {
                    ...
                    if (result !== null) {
                        for (let i = 0; i < result.length; i++) {
                            ...
                            else if(element.LinksCategoryLCode == 5){
                                setWebsiteLink(element.linkPath)
                            }
                        }
                        setLoader(true)
                    }
    ...
    if (!loader) {
        ...
        return (
            <View style={styles.headerContainer}>
                ...
                <View style={styles.separator} />
                {FacebookLink !== null || InstagramLink !== null || LinkedlnLink !== null || WebsiteLink !== null || TwitterLink !== null ?
                ...
                <View style={styles.socialMediaRow}>
                    ...
                    {WebsiteLink !== null ? <SocialIcon type='medium' onPress={() => { Linking.openURL(WebsiteLink) }} /> : null}
                    ...
                    {LinkedlnLink !== null ? <SocialIcon type='gitlab' onPress={() => { Linking.openURL(LinkedlnLink) }} /> : null}
                </View>
            </View>
        );
    }
